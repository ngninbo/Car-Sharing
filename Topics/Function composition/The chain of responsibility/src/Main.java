...
class ChainOfResponsibilityDemo {
     ...
     */
    static RequestHandler commonRequestHandler = wrapInTransactionTag.setNextHandler(createDigest)
            .setNextHandler(wrapInRequestTag); // !!! write a combination of existing handlers here
